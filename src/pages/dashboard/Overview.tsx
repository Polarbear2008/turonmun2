...
export default function Overview() {
  ...
  const displayCountry = application?.country || 'Not assigned yet';
  const committeeName = committee?.name || application?.committee_preference1 || 'Not assigned yet';
  ...
  const applicationSteps = [
    ...
    { name: 'Allocated', status: application?.assigned_committee_id ? 'completed' : 'pending', date: null },
  ];
          ...
          <div className="space-y-4">
            <div className="glass-panel p-4 rounded-lg">
              ...
              <p className="text-white/60 text-xs">
                Economic and Social Council - Addressing global economic challenges
              </p>
