...
import { ArrowLeft, Leaf, Users, Globe, Award, BarChart3 } from 'lucide-react';
  ...
  return (
    <PageLayout>
      ...
      >
                ...
                <motion.div variants={itemVariants} className="mb-16">
                  ...
                  <div className="prose prose-lg max-w-none">
                    <p className="text-gray-600 mb-6 text-center">
                      Our second season focused on addressing climate change and promoting sustainable 
                      development through international cooperation and innovative solutions.
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-12">
                      <div className="bg-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100">
                        <div className="w-12 h-12 bg-diplomatic-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                          <Leaf className="text-diplomatic-600 h-6 w-6" />
                        </div>
                        <h4 className="font-bold text-lg mb-2 text-center text-gray-800">Climate Initiatives</h4>
                        <p className="text-gray-600 text-center text-sm">
                          Delegates proposed innovative solutions to address climate change.
                        </p>
                      </div>
                      ...
                      <div className="bg-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100">
                        ...
                        <h4 className="font-bold text-lg mb-2 text-center text-gray-800">Global Cooperation</h4>
                        <p className="text-gray-600 text-center text-sm">
                          {seasonData.statistics.countries} nations joined forces to tackle environmental challenges.
                        </p>
                      </div>
                      ...
                      <div className="bg-diplomatic-50 p-6 rounded-xl shadow-sm border border-diplomatic-100">
                        ...
                        <h4 className="font-bold text-lg mb-2 text-center text-gray-800">Participant Engagement</h4>
                        <p className="text-gray-600 text-center text-sm">
                          {seasonData.statistics.participants} dedicated delegates worked on sustainability solutions.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        {/* Statistics Section with Environmental Theme */}
            ...
            >
              <motion.div variants={itemVariants} className="text-center mb-16">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Our second season brought together environmental experts and future leaders to address pressing climate challenges.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div variants={itemVariants} className="text-center mb-16">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Memorable moments from our second season focused on climate action.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div variants={itemVariants} className="text-center mb-16">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Our Environmental Team</h3>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Meet the dedicated team who made our climate-focused season possible.
                </p>
              </motion.div>
